...
"""
Scraping and getting the url of a siter that is being searched,
this will be done using the serpapi,
it should go through the urls, search them get the relevant information, and return the url
"""
